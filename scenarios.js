...
// ── Catéchisme ───────────────────────────────────────────────────────────────
// Tableaux de rappel : données et rendu dans refactor/catechismes.data.js
// (renderCatechisme), qui remplace l'ancien objet _CATE_GRADE.
...
function afficherCatechisme(grade) {
    ...
    if (!el) return;
    el.innerHTML = (typeof renderCatechisme === 'function') ? renderCatechisme(grade) : '';
